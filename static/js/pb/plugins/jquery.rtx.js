	...
	$.extend($.rtx, {
		...
		updateStatus: function(nick, ids) {
			...
			$.each(ids, function(i, id) {
				$("#" + id).attr("src", "/cdb_mtnc/img/rtx-" + status[0] + "-" + status[1] + ".gif");
			});
		},
		...
		addNick: function(obj) {
			...
			var img = $("<img src='/cdb_mtnc/img/rtx-blank.gif' style='width:16px;height:16px;margin:0 3px;vertical-align:middle;' id='" + imgid + "' class='rtx_icon' />");
			//img.attr("nick", nick);
			$obj.before(img);
